...
st.beta_set_page_config(page_title="Face_Detection_App",page_icon=img)
...
def main():
	...
	if choice == 'Face Detection':
		...
		st.markdown("#### By: Hrishikesh Malkar")
		st.markdown("###### Reference: [Jesse E.Agbe ([JCharisTech] (https://www.jcharistech.com/))]")
